...
public class GherkinTest {
	...
	public void testMathcer(String stepDescription, String stepCall,
			boolean expectedMathch, Object[] expectedArgs) {
		GherkinStepMatcher matcher = new GherkinStepMatcher();
		boolean result =
				matcher.matches(stepDescription, stepCall, new HashMap<String, Object>());
		Validator.assertThat(result, Matchers.equalTo(expectedMathch));

		List<String[]> rargs = matcher.getArgsFromCall(stepDescription, stepCall,
	...
	public Iterator<Object[]> gettestMathcerData() {
		...
		data.add(new Object[]{"^it should have \"([^\"]*)\" in search results$",
				"it should have \"QMetry Automation Framework\" in search results", true,
		...
		data.add(new Object[]{
				...
				"the customer searches for books published between 2013 and 2014", true,
