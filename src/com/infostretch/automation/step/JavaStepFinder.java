...
import static com.infostretch.automation.keys.ApplicationProperties.STEP_PROVIDER_PKG;
...
/**
 * com.infostretch.automation.step.JavaStepFinder.java
 * 
 * @author chirag.jayswal
 */
public final class JavaStepFinder {
	public static final String STEPS_PACKAGE = "com.infostretch.automation.step";

	public static Map<String, TestStep> getAllJavaSteps() {
		Map<String, TestStep> stepMapping = new HashMap<String, TestStep>();
		Collection<URL> urls = ClasspathHelper.forPackage("com.infostretch.automation.step");
