...
import com.infostretch.automation.data.MetaDataScanner;
import com.infostretch.automation.ui.AbstractTestPage;
...
public class ElementFactory {
			...
			try {
				...
				if (isDecoratable(field)) {
					...
					if (hasAnnotation(field, FindBy.class, FindBys.class)) {
						...
						com.infostretch.automation.ui.annotations.FindBy findBy = field
								.getAnnotation(com.infostretch.automation.ui.annotations.FindBy.class);
						if (List.class.isAssignableFrom(field.getType())) {
	...
	private boolean isDecoratable(Field field) {
		if (!hasAnnotation(field, com.infostretch.automation.ui.annotations.FindBy.class, FindBy.class,
				FindBys.class)) {
			return false;
		}
