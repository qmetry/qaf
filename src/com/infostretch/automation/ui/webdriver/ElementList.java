...
/**
 * com.infostretch.automation.ui.webdriver.List.java
 * 
 * @author chirag
 */
		...
		if (JSONUtil.isValidJsonString(locator)) {
			try {
				...
				description = map.containsKey("desc") ? (String) map.get("desc")
						: map.containsKey("description") ? (String) map.get("description") : by.toString();
				cacheable = map.containsKey("cacheable") ? (Boolean) map.get("cacheable") : false;
